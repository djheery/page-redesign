const FAMILY_TOPICS = (() => {
  const state = FAMILY_TOPICS_STATE;
  ...
  const topics = FAMILY_TOPICS_STATE.get_topics();
...
})(FAMILY_TOPICS_STATE, SC_CONTENT)


FAMILY_TOPICS.init(FAMILY_TOPICS_STATE, SC_CONTENT);
